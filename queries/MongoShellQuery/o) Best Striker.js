            ...
            $project:
                {
                    ...
                    minutespergoal: { $cond: [ { $gt: ["$goals", 0] }, { $divide: ["$minutes", "$goals"] }, 0 ] },
                    minutespergame: { $cond: [ { $gt: ["$minutes", 0] }, { $divide: ["$minutes", "$games"] }, 0 ] },
                    score:
                        {
                            $sum:
                                [
                                    { $cond: [ { $gt: ["$goals", 0] }, { $divide: ["$goals", "$games"] }, 0 ]},
                                    {
                                        $cond:
                                            [
                                                { $gt: ["$shotsOnGoal", 0] }, { $divide: ["$goals", "$shotsOnGoal"] }, "$shotsOnGoal"
                                            ]
                                    },
                                    {
                                        $cond:
                                            [
                                                { $gt: ["$shots", 0] }, { $divide: ["$shotsOnGoal", "$shots"] }, "$shots"
                                            ]
                                    },
                                    {
                                        $cond:
                                            [
                                                { $gt: ["$offsides", 0] }, { $divide: ["$shotsOnGoal", "$offsides"] }, "$offsides"
                                            ]
                                    },
                                ]
                        }
