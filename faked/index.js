...
const tasks = {
    ...
    contracts: [
        ...
        'managers',
        results => {
            const players = _.chunk(
                results.players,
                results.players.length / results.teams.length
            );
    ...
    events: [
        ...
        results => {
            ...
            const players = _.sampleSize(
                results.players,
                _.random(results.players.length)
            );
    ...
    awards: [
        ...
        results => {
            ...
            const manOfMatch = faker.fakeAward({
                gameId,
                personId: player._id,
            ...
            const managerOfMonth = faker.fakeAward({
                personId: manager._id,
